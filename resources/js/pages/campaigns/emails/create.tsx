...
export default function CreateCampaignEmail({ campaign, templates }: Readonly<Props>) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Email', href: `/admin/campaigns/${campaign.id}/emails/create` },
  ];

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(`/admin/campaigns/${campaign.id}/emails`);
  };
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={`Create Email - ${campaign.name}`} />

      <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold">Create Campaign Email</h1>
            ...
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    This email will be queued as pending and can be sent to all confirmed subscribers.
                  </CardDescription>
                </CardHeader>
