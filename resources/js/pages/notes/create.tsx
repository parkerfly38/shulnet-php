...
import { BreadcrumbItem, Member, User } from '@/types';
...
export default function CreateNote({ members, users }: CreateNoteProps) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Note</h1>
                        <p className="text-gray-600 dark:text-gray-400">Add a new note to the system</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Enter the basic details for the note
                                </CardDescription>
                            </CardHeader>
