...
export default function EditSchoolTuitionTier({ tier }: Props) {
  ...
  const { data, setData, put, processing, errors } = useForm<FormData>({
    ...
    max_students: tier.max_students?.toString() || '',
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    put(`/admin/school-tuition-tiers/${tier.id}`);
  };
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: tier.name, href: `/admin/school-tuition-tiers/${tier.id}` },
    { title: 'Edit', href: `/admin/school-tuition-tiers/${tier.id}/edit`},
  ];
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        ...
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Edit Tuition Tier</h1>
