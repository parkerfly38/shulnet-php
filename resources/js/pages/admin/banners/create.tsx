...
export default function BannersCreate() {
  const { data, setData, post, processing, errors } = useForm({
    ...
    target_audience: 'all' as 'members' | 'students' | 'parents' | 'all',
    ...
    send_as_push_notification: false,
    action_url: '',
    action_text: '',
  });
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Create a new banner message to display to users
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Card className="max-w-3xl">
            <CardHeader>
              ...
              <CardDescription>
                Enter the details for the new banner message
              </CardDescription>
            </CardHeader>
