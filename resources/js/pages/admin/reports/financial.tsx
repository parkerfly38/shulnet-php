                            ...
                            <>
                                ...
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="text-2xl font-bold">{incomeSummary.payment_count}</div>
                                            <p className="text-xs text-muted-foreground">
                                                Payments received
                                            </p>
                                        </CardContent>
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="text-2xl font-bold">
                                                {formatCurrency(incomeSummary.payment_count > 0 ? incomeSummary.total_revenue / incomeSummary.payment_count : 0)}
                                            </div>
                                            <p className="text-xs text-muted-foreground">
                                                Per transaction
                                            </p>
