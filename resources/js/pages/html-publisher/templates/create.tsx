...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Create',
    href: '/admin/html-templates/create',
  },
];

export default function HtmlTemplateCreate() {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    router.post('/admin/html-templates', {
      name,
      description,
      header,
      footer,
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Create HTML Template" />

      <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <div>
          <h1 className="text-3xl font-bold">Create HTML Template</h1>
          <p className="text-gray-600 dark:text-gray-400">Create a reusable HTML template with header and footer</p>
        </div>
