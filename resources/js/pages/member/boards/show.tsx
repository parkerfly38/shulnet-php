...
import type { BoardMembership, Meeting, Report } from '@/types';
...
export default function BoardShow({ board, upcomingMeetings, reports }: Readonly<Props>) {
