...
class YahrzeitsImport implements SkipsOnError, SkipsOnFailure, ToModel, WithHeadingRow, WithValidation, WithBatchInserts, WithChunkReading
{
    ...
    public function model(array $row): \Illuminate\Database\Eloquent\Model|array|null
    {
        ...
        if ($yahrzeit) {
            ...
            $yahrzeit->update([
                ...
                'hebrew_month_of_death' => $row['hebrew_month_of_death'] ?? $yahrzeit->hebrew_month_of_death,
        ...
        return new Yahrzeit([
            ...
            'hebrew_month_of_death' => $row['hebrew_month_of_death'] ?? null,
    ...
    public function getErrors(): array
    {
        ...
        return array_merge($errors, $this->importErrors);
    }
